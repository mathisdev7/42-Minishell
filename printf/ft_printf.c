...
/*   Updated: 2025/01/20 14:01:02 by mazeghou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_print_format(va_list args, char format, int print_len, void *p)
{
	...
	if (format == 's')
	{
		...
		print_len = printf_putstr_fd(str, 1);
	}
	else if (format == 'c')
		print_len = printf_putchar_fd(va_arg(args, int), 1);
	else if (format == 'p')
	{
		p = va_arg(args, void *);
