...
utils_args.c utils_env.c utils_env2.c utils_cmd.c utils_var.c \
parsing/redirections/redirections.c parsing/redirections/redirections2.c \
parsing/utils.c parsing/quotes.c parsing/cmd.c parsing/remove_quotes.c \
exec/cmd_utils.c exec/pipes.c exec/handle.c signals.c
